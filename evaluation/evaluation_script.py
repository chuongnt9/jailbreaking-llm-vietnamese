...
# Load the Excel file
file_path = "gpt-4.xlsx"
workbook = openpyxl.load_workbook(file_path)

#skip_sheet = ["Role_playing", "AIM", "Prefix_injection", "Refusal_suppression", "Combination_1", "Combination_2"]
skip_sheet = []
