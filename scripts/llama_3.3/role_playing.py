...
if __name__ == "__main__":
    ...
    excel_path = Path(__file__).parent / "../../datasets/roleplaying_dataset.xlsx"
        ...
        for start_row in range(0, len(jailbreak_data), 10):  # Process every 10 rows
            ...
            for prompt in crime_prompts:
                if pd.notnull(prompt):  # Only add non-null prompts
                    ...
                    concatenated_prompt = f"{prompt} {role_playing_prompt}"
    ...
    result_path = Path(__file__).parent / "../../result/llama_3.3/llama_role_playing_eng.xlsx"
